...
const heroRoleCardSlots: HeroRoleCardSlot[] = [
  ...
  { id: "main", src: "/images/login-agent-portrait.png", alt: "", slot: "main", zIndex: 6, tone: "main", objectPosition: "50% 50%", subjectScale: 0.99, subjectOffsetX: 0, subjectOffsetY: 0, mobile: true },
];
