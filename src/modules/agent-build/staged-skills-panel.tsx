...
export function StagedSkillsPanel({ agentId }: { agentId: number }) {
  ...
  const saveConfig = async (scope: "global" | "agent", config: Record<string, unknown>) => {
    ...
    try {
      ...
      setConfigSkill(null); setMessage("技能配置已保存");
