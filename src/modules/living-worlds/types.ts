...
export type WorldProjectionAudience = "creator" | "operator" | "agent-owner";
export interface WorldCreatorProjection { audience: "creator"; world_code: string; status: string; revision: number; runtime_health: string; public_residents: WorldProjectionResident[]; timeline: WorldTimelineItem[]; creator_audit_summary?: string; next_cursor?: string }
export interface WorldOperatorProjection { audience: "operator"; world_code: string; status: string; revision: number; runtime_health: string; public_residents: WorldProjectionResident[]; timeline: WorldTimelineItem[]; next_cursor?: string }
export interface WorldAgentOwnerProjection { audience: "agent-owner"; world_code: string; status: string; revision: number; owned_participant: WorldProjectionResident; timeline: WorldTimelineItem[]; next_cursor?: string }
