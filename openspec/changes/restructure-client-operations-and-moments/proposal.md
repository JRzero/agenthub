...
- Preserve Live/Demo isolation and never fabricate Workspace Clients, Moment drafts, review states, downline states, browser counts, settings, or successful writes.
...
- Uses only existing Agent, AgentClient, shared-session, Moment, comment, upload, runtime-version, and export contracts.
